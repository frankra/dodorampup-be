...
public class PersistenceJPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory()
		...
		em.setPackagesToScan(new String[] { "com.sap.csc.dodorampup.model" });
		...
		/**
		 * Generates only the DDL file. Do not automatically create the database
		 * schema.
		 */
		properties.put(PersistenceUnitProperties.DDL_GENERATION_MODE,
			PersistenceUnitProperties.DEFAULT_DDL_GENERATION_MODE);
